...
export const releases: Release[] = [
  {
    ...
    dek: "The Fort Lauderdale group behind Jay's, Naked Taco and HIGHBAR rebrands under a single house with one standard: elevated hospitality.",
    date: "2026-07-13",
    ...
    body: [
      ...
      "The change is a matter of clarity, not direction. Jay's, Naked Taco and HIGHBAR each keep their own name, team and character. Room 7 is the standard they share: design-led rooms, a point of view behind every menu, and a night that starts at dinner and doesn't stop there.",
      ...
      "The group's flagship, Jay's, occupies a restored 1920s church in Flagler Village. Naked Taco and its rooftop, HIGHBAR, sit together at 1111 Collins Avenue in Miami Beach.",
    ],
  },
  {
