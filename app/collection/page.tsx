            ...
            <Reveal key={v.slug} delay={(i % 2) * 60}>
              ...
              >
                <div className={`relative aspect-[16/10] overflow-hidden md:aspect-auto md:min-h-[340px] ${i % 2 ? "md:order-2" : ""}`}>
                  <Placeholder tone={TONES[v.slug]} seed={`idx-${v.slug}`} src={v.heroImage} alt={`${v.name}, ${v.nickname}`} showLabel={false} sizes="(min-width: 768px) 50vw, 100vw" className="venue-card__img absolute inset-0" />
